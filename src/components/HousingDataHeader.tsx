export function HousingDataHeader() {
  return (
    <header className="housing-data-header" aria-labelledby="housing-data-title">
      <h2 id="housing-data-title">70 城价格指数趋势</h2>
      <p className="housing-data-description">基于国家统计局公开的 70 城住宅价格指数构建看板</p>
      <section className="methodology-note" aria-labelledby="methodology-title">
        <h3 id="methodology-title">口径说明</h3>
